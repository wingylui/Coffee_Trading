...
const productionURL = "https://raw.githubusercontent.com/wingylui/coffee_trading_API/main/map/production.json";
  ...
  var productionChoropleth = L.choropleth(data, {
    ...
    onEachFeature: function(features, layer) {
      layer.bindPopup('<div id="foo"></div>').on('popupopen', function (e) {
        ...
        let graphURL = "https://raw.githubusercontent.com/wingylui/coffee_trading_API/main/trade_popup/" + features.properties.CountryName + ".json";
...
// identify import url
const importURL = "https://raw.githubusercontent.com/wingylui/coffee_trading_API/main/map/import.json";
...
// identify export url
const exportURL = "https://raw.githubusercontent.com/wingylui/coffee_trading_API/main/map/export.json";
...
// identify export url
const reExportURL = "https://raw.githubusercontent.com/wingylui/coffee_trading_API/main/map/re-export.json";
